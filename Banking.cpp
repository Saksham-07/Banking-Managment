...
void Bank::show(){
	...
	for(int i=0;i<total;i++){
		...
		cout<<"Balance in Bank: "<<person[i].cash<<endl;
...
void Bank::transactions(){
	...
	cout<<"Enter id of student who is going to do transaction"<<endl;
     ...
     for(int i=0;i<total;i++){
     	...
     	if(id==person[i].ID){
		     ...
		     cout<<"\nExisting Balance in Bank "<<person[i].cash<<endl;
		     ...
		     switch(ch){
		     	...
		     	case '1':
		     		...
		     		cout<<"Your new Balance in Bank is "<<person[i].cash<<endl;
